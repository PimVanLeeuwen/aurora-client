...
export class Client {
     ...
     * @return Ok
     */
    getOidcParameters(): Promise<OidcConfig> {
    ...
    protected processGetOidcParameters(response: Response): Promise<OidcConfig> {
        ...
        if (status === 200) {
            ...
            result200 = OidcConfig.fromJS(resultData200);
            return result200;
            });
        ...
        return Promise.resolve<OidcConfig>(null as any);
    }
    ...
    protected processGetInformation(response: Response): Promise<User> {
        ...
        if (status === 200) {
            ...
            result404 = HttpApiException.fromJS(resultData404);
     ...
     * @return Ok
     */
    getPhoto(body: GEWISPhotoAlbumParams): Promise<PhotoResponse> {
        let url_ = this.baseUrl + "/screen/poster/photo";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetPhoto(response: Response): Promise<PhotoResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PhotoResponse>(null as any);
    }
    ...
    getKeyHolders(): Promise<Member[]> {
        let url_ = this.baseUrl + "/infoscreen/keyholders";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetKeyHolders(_response);
        });
    }

    protected processGetKeyHolders(response: Response): Promise<Member[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    getBoard(): Promise<Member[]> {
        let url_ = this.baseUrl + "/infoscreen/board";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetBoard(response: Response): Promise<Member[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    getERO(): Promise<Member[]> {
        let url_ = this.baseUrl + "/infoscreen/ero";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetERO(_response);
        });
    }

    protected processGetERO(response: Response): Promise<Member[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    enableTimeTrailRace(body: TimeTrailRaceParams): Promise<string> {
        let url_ = this.baseUrl + "/modes/time-trail-race";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processEnableTimeTrailRace(_response);
        });
    }

    protected processEnableTimeTrailRace(response: Response): Promise<string> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
    ...
    disableTimeTrailRacing(): Promise<void> {
        let url_ = this.baseUrl + "/modes/time-trail-race";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processDisableTimeTrailRacing(_response);
        });
    }

    protected processDisableTimeTrailRacing(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Ok
     */
    getRaceState(): Promise<Anonymous7> {
        let url_ = this.baseUrl + "/modes/time-trail-race";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetRaceState(_response);
        });
    }

    protected processGetRaceState(response: Response): Promise<Anonymous7> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            ...
            let result404: any = null;
            let resultData404 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result404 = ModeDisabledError.fromJS(resultData404);
            return throwException("Time Trail Race not enabled", status, _responseText, _headers, result404);
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
     ...
     * @return Ok
     */
    raceRegisterPlayer(body: RegisterPlayerParams): Promise<RacePlayerRegisteredEvent> {
        let url_ = this.baseUrl + "/modes/time-trail-race/register-player";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processRaceRegisterPlayer(_response);
        });
    }

    protected processRaceRegisterPlayer(response: Response): Promise<RacePlayerRegisteredEvent> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = RacePlayerRegisteredEvent.fromJS(resultData200);
            return result200;
            });
        } else if (status === 404) {
            return response.text().then((_responseText) => {
            ...
            let result411: any = null;
            let resultData411 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result411 = InvalidStateError.fromJS(resultData411);
            return throwException("Time Trail Race not in INITIALIZED or SCOREBOARD state", status, _responseText, _headers, result411);
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        ...
        return Promise.resolve<RacePlayerRegisteredEvent>(null as any);
    }

    /**
     * @return Ok
     */
    raceReady(): Promise<RacePlayerReadyEvent> {
        let url_ = this.baseUrl + "/modes/time-trail-race/ready";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processRaceReady(_response);
        });
    }

    protected processRaceReady(response: Response): Promise<RacePlayerReadyEvent> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = RacePlayerReadyEvent.fromJS(resultData200);
            return result200;
            });
        } else if (status === 404) {
            return response.text().then((_responseText) => {
            ...
            let resultData411 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result411 = InvalidStateError.fromJS(resultData411);
            return throwException("Time Trail Race not in PLAYER_REGISTERED state", status, _responseText, _headers, result411);
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        ...
        return Promise.resolve<RacePlayerReadyEvent>(null as any);
    }

    /**
     * @return Ok
     */
    raceStart(): Promise<RaceStartedEvent> {
        let url_ = this.baseUrl + "/modes/time-trail-race/start";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processRaceStart(_response);
        });
    }

    protected processRaceStart(response: Response): Promise<RaceStartedEvent> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = RaceStartedEvent.fromJS(resultData200);
            return result200;
            });
        } else if (status === 404) {
            return response.text().then((_responseText) => {
            ...
            let resultData411 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result411 = InvalidStateError.fromJS(resultData411);
            return throwException("Time Trail Race not in PLAYER_READY state", status, _responseText, _headers, result411);
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        ...
        return Promise.resolve<RaceStartedEvent>(null as any);
    }

    /**
     * @return Ok
     */
    raceFinish(): Promise<RaceFinishedEvent> {
        let url_ = this.baseUrl + "/modes/time-trail-race/finish";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processRaceFinish(_response);
        });
    }

    protected processRaceFinish(response: Response): Promise<RaceFinishedEvent> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = RaceFinishedEvent.fromJS(resultData200);
            return result200;
            });
        } else if (status === 404) {
            return response.text().then((_responseText) => {
            ...
            let resultData411 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result411 = InvalidStateError.fromJS(resultData411);
            return throwException("Time Trail Race not in STARTED state", status, _responseText, _headers, result411);
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        ...
        return Promise.resolve<RaceFinishedEvent>(null as any);
    }

    /**
     * @return Ok
     */
    raceRevealScore(): Promise<RaceScoreboardEvent> {
        let url_ = this.baseUrl + "/modes/time-trail-race/reveal-score";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processRaceRevealScore(_response);
        });
    }

    protected processRaceRevealScore(response: Response): Promise<RaceScoreboardEvent> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = RaceScoreboardEvent.fromJS(resultData200);
            return result200;
            });
        } else if (status === 404) {
            return response.text().then((_responseText) => {
            ...
            let resultData411 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result411 = InvalidStateError.fromJS(resultData411);
            return throwException("Time Trail Race not in FINISHED state", status, _responseText, _headers, result411);
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        ...
        return Promise.resolve<RaceScoreboardEvent>(null as any);
    }
     ...
     * @return Ok
     */
    spotifyLoginCallback(state: string, code: string | undefined, error: string | undefined): Promise<Anonymous8> {
    ...
    protected processSpotifyLoginCallback(response: Response): Promise<Anonymous8> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class OidcConfig implements IOidcConfig {
    clientId!: string;
    redirectUri!: string;
    authUrl!: string;

    constructor(data?: IOidcConfig) {
        if (data) {
    ...
    static fromJS(data: any): OidcConfig {
        data = typeof data === 'object' ? data : {};
        let result = new OidcConfig();
        result.init(data);
        return result;
    }
...
export class HttpApiException implements IHttpApiException {
    name!: string;
    message!: string;
    stack?: string;
    statusCode!: number;

    constructor(data?: IHttpApiException) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): HttpApiException {
        data = typeof data === 'object' ? data : {};
        let result = new HttpApiException();
        result.init(data);
        return result;
    }
...
export interface IHttpApiException {
    name: string;
    message: string;
    stack?: string;
    statusCode: number;
...
export class GEWISPhotoAlbumParams implements IGEWISPhotoAlbumParams {
    albumIds!: number[];

    constructor(data?: IGEWISPhotoAlbumParams) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GEWISPhotoAlbumParams {
        data = typeof data === 'object' ? data : {};
        let result = new GEWISPhotoAlbumParams();
        result.init(data);
        return result;
    }
...
export interface IGEWISPhotoAlbumParams {
    albumIds: number[];
}
...
export class Information implements IInformation {
    ...
    alcoholTime!: AlcoholTime | undefined;
    firstResponsible!: string | undefined;
    secondResponsible!: string | undefined;
    firstERO!: string | undefined;
    secondERO!: string | undefined;
...
export class TimeTrailRaceParams implements ITimeTrailRaceParams {
    lightsGroupIds!: number[];
    screenIds!: number[];
    audioIds!: number[];
    sessionName!: string;

    constructor(data?: ITimeTrailRaceParams) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TimeTrailRaceParams {
        data = typeof data === 'object' ? data : {};
        let result = new TimeTrailRaceParams();
        result.init(data);
        return result;
    }
...
export interface ITimeTrailRaceParams {
    lightsGroupIds: number[];
    screenIds: number[];
    audioIds: number[];
    sessionName: string;
...
export class ScoreboardItem implements IScoreboardItem {
    name!: string;
    alcoholFree!: boolean;
    bac!: boolean;
    uuid!: string;
    ...
    constructor(data?: IScoreboardItem) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.name = _data["name"];
            this.alcoholFree = _data["alcoholFree"];
            this.bac = _data["bac"];
            this.uuid = _data["uuid"];
            this.timeMs = _data["timeMs"];
        }
    }

    static fromJS(data: any): ScoreboardItem {
        data = typeof data === 'object' ? data : {};
        let result = new ScoreboardItem();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["name"] = this.name;
        data["alcoholFree"] = this.alcoholFree;
        data["bac"] = this.bac;
        data["uuid"] = this.uuid;
...
export class ModeDisabledError implements IModeDisabledError {
    name!: string;
    message!: string;
    stack?: string;

    constructor(data?: IModeDisabledError) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ModeDisabledError {
        data = typeof data === 'object' ? data : {};
        let result = new ModeDisabledError();
        result.init(data);
        return result;
    }
...
export interface IModeDisabledError {
    name: string;
    message: string;
    stack?: string;
}

export class RaceBaseEvent implements IRaceBaseEvent {
    sessionName!: string;

    [key: string]: any;

    constructor(data?: IRaceBaseEvent) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): RaceBaseEvent {
        data = typeof data === 'object' ? data : {};
        let result = new RaceBaseEvent();
        result.init(data);
        return result;
    }
...
export interface IRaceBaseEvent {
    sessionName: string;

    [key: string]: any;
}

export enum PLAYER_REGISTERED {
    PLAYER_REGISTERED = "PLAYER_REGISTERED",
}
...
export class PlayerParams implements IPlayerParams {
    ...
    static fromJS(data: any): PlayerParams {
        data = typeof data === 'object' ? data : {};
        let result = new PlayerParams();
        result.init(data);
        return result;
    }
...
export class RacePlayerRegisteredEvent extends RaceBaseEvent implements IRacePlayerRegisteredEvent {
    ...
    constructor(data?: IRacePlayerRegisteredEvent) {
        super(data);
        if (!data) {
            this.scoreboard = [];
            this.player = new PlayerParams();
        }
    }
    ...
    init(_data?: any) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["scoreboard"])) {
                this.scoreboard = [] as any;
                for (let item of _data["scoreboard"])
                    this.scoreboard!.push(ScoreboardItem.fromJS(item));
            }
            this.player = _data["player"] ? PlayerParams.fromJS(_data["player"]) : new PlayerParams();
            this.state = _data["state"];
        }
    }

    static fromJS(data: any): RacePlayerRegisteredEvent {
        data = typeof data === 'object' ? data : {};
        let result = new RacePlayerRegisteredEvent();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.scoreboard)) {
            data["scoreboard"] = [];
            for (let item of this.scoreboard)
                data["scoreboard"].push(item.toJSON());
        }
...
export interface IRacePlayerRegisteredEvent extends IRaceBaseEvent {
    scoreboard: ScoreboardItem[];
    player: PlayerParams;
    state: PLAYER_REGISTERED;
...
export class InvalidStateError implements IInvalidStateError {
    name!: string;
    message!: string;
    stack?: string;

    constructor(data?: IInvalidStateError) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): InvalidStateError {
        data = typeof data === 'object' ? data : {};
        let result = new InvalidStateError();
        result.init(data);
        return result;
    }
...
export interface IInvalidStateError {
    name: string;
    message: string;
    stack?: string;
}

export class RegisterPlayerParams implements IRegisterPlayerParams {
    name!: string;
    alcoholFree!: boolean;
    bac!: boolean;

    constructor(data?: IRegisterPlayerParams) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): RegisterPlayerParams {
        data = typeof data === 'object' ? data : {};
        let result = new RegisterPlayerParams();
        result.init(data);
        return result;
    }
...
export interface IRegisterPlayerParams {
    name: string;
    alcoholFree: boolean;
    bac: boolean;
}

export enum PLAYER_READY {
    PLAYER_READY = "PLAYER_READY",
}

export class RacePlayerReadyEvent extends RaceBaseEvent implements IRacePlayerReadyEvent {
    player!: PlayerParams;
    state!: PLAYER_READY;

    [key: string]: any;

    constructor(data?: IRacePlayerReadyEvent) {
        super(data);
        if (!data) {
            this.player = new PlayerParams();
        }
    ...
    static fromJS(data: any): RacePlayerReadyEvent {
        data = typeof data === 'object' ? data : {};
        let result = new RacePlayerReadyEvent();
        result.init(data);
        return result;
    }
...
export interface IRacePlayerReadyEvent extends IRaceBaseEvent {
    player: PlayerParams;
    state: PLAYER_READY;
...
export class RaceStartedEvent extends RaceBaseEvent implements IRaceStartedEvent {
    startTime!: Date;
    player!: PlayerParams;
    state!: STARTED;
    ...
    constructor(data?: IRaceStartedEvent) {
        super(data);
        if (!data) {
            this.player = new PlayerParams();
        }
    ...
    static fromJS(data: any): RaceStartedEvent {
        data = typeof data === 'object' ? data : {};
        let result = new RaceStartedEvent();
        result.init(data);
        return result;
    }
...
export interface IRaceStartedEvent extends IRaceBaseEvent {
    startTime: Date;
    player: PlayerParams;
    state: STARTED;
...
export class RaceFinishedEvent extends RaceBaseEvent implements IRaceFinishedEvent {
    scoreboard!: ScoreboardItem[];
    ...
    constructor(data?: IRaceFinishedEvent) {
        super(data);
        if (!data) {
            this.scoreboard = [];
            this.player = new ScoreboardItem();
        }
    }
    ...
    init(_data?: any) {
        ...
        if (_data) {
            ...
            this.player = _data["player"] ? ScoreboardItem.fromJS(_data["player"]) : new ScoreboardItem();
            this.state = _data["state"];
        }
    }

    static fromJS(data: any): RaceFinishedEvent {
        data = typeof data === 'object' ? data : {};
        let result = new RaceFinishedEvent();
        result.init(data);
        return result;
    }
...
export interface IRaceFinishedEvent extends IRaceBaseEvent {
    scoreboard: ScoreboardItem[];
    player: ScoreboardItem;
    state: FINISHED;
...
export class RaceScoreboardEvent extends RaceBaseEvent implements IRaceScoreboardEvent {
    player!: ScoreboardItem;
    scoreboard!: ScoreboardItem[];
    state!: SCOREBOARD;
    ...
    constructor(data?: IRaceScoreboardEvent) {
        super(data);
        if (!data) {
            this.player = new ScoreboardItem();
            this.scoreboard = [];
    ...
    static fromJS(data: any): RaceScoreboardEvent {
        data = typeof data === 'object' ? data : {};
        let result = new RaceScoreboardEvent();
        result.init(data);
        return result;
    }
...
export interface IRaceScoreboardEvent extends IRaceBaseEvent {
    player: ScoreboardItem;
    scoreboard: ScoreboardItem[];
    state: SCOREBOARD;
...
export class ParResponse implements IParResponse {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.shutterChannel = _data["shutterChannel"];
    ...
    toJSON(data?: any) {
        ...
        data["shutterChannel"] = this.shutterChannel;
...
export class ShutterOptionValues implements IShutterOptionValues {
    open!: number;
    strobe!: number;

    constructor(data?: IShutterOptionValues) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.strobe = _data["strobe"];
        }
    }

    static fromJS(data: any): ShutterOptionValues {
        data = typeof data === 'object' ? data : {};
        let result = new ShutterOptionValues();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["open"] = this.open;
        data["strobe"] = this.strobe;
        return data;
    }
}

export interface IShutterOptionValues {
    open: number;
    strobe: number;
}
...
export class LightsParCreateParams implements ILightsParCreateParams {
    ...
    constructor(data?: ILightsParCreateParams) {
        ...
        if (!data) {
            this.shutterOptionValues = new ShutterOptionValues();
        }
    }
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.masterDimChannel = _data["masterDimChannel"];
            this.shutterChannel = _data["shutterChannel"];
            this.shutterOptionValues = _data["shutterOptionValues"] ? ShutterOptionValues.fromJS(_data["shutterOptionValues"]) : new ShutterOptionValues();
    ...
    toJSON(data?: any) {
        ...
        data["masterDimChannel"] = this.masterDimChannel;
        data["shutterChannel"] = this.shutterChannel;
        data["shutterOptionValues"] = this.shutterOptionValues ? this.shutterOptionValues.toJSON() : <any>undefined;
